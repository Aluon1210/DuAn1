...
class Product_Varirant extends Model
{
    ...
    public function getAllWithRelations()
    {
        $sql = "SELECT pv.Variant_Id as id,
                       ...
                       pv.SKU as sku
                FROM {$this->table} pv
                LEFT JOIN products p ON pv._Product_Id = p.Product_Id
    ...
    {
        $sql = "SELECT * FROM {$this->table} WHERE _Product_Id = :pid";
        $stmt = $this->db->prepare($sql);
    ...
    public function createVariant(array $data)
    {
        ...
        $payload = [
            ...
            '_Product_Id' => trim($data['product_id'] ?? ''),
