...
<div style="display: grid; grid-template-columns: 250px 1fr; gap: 20px;">
        ...
        <div class="category-list">
            ...
            <?php foreach ($categories as $category): ?>
                <a href="<?php echo ROOT_URL; ?>product/category/<?php echo $category['id']; ?>" 
                   style="<?php echo isset($currentCategory) && $currentCategory['id'] == $category['id'] ? 'background-color: #3498db; color: white;' : ''; ?>">
    ...
    <div>
        ...
        <h2 style="margin-top: 20px; color: #2c3e50;">Danh mục: <?php echo isset($currentCategory) ? htmlspecialchars($currentCategory['name']) : ''; ?></h2>
