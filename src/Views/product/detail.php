...
<?php if ($product): ?>
    <div style="background-color: white; padding: 20px; border-radius: 8px;">
        <a href="<?php echo ROOT_URL; ?>product" class="btn btn-primary">← Quay lại</a>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px; margin-top: 20px;">
            ...
            <!-- Thông tin sản phẩm -->
            <div>
                <h1 style="color: #2c3e50; margin-bottom: 15px;"><?php echo htmlspecialchars($product['name']); ?></h1>
                ...
                <h3 style="color: #2c3e50; margin-top: 25px; margin-bottom: 10px;">Mô tả sản phẩm</h3>
                <p style="line-height: 1.6; color: #555; margin-bottom: 20px;">
                    <?php echo nl2br(htmlspecialchars($product['description'])); ?>
                </p>

                <?php if ($product['quantity'] > 0): ?>
                    <form method="POST" action="<?php echo ROOT_URL; ?>cart/add/<?php echo $product['id']; ?>" style="margin-top: 20px;">
