<?php
// File: src/Views/layouts/client_layout.php
?>
<!DOCTYPE html>
<html lang="vi">
<head>
    ...
    <title><?php echo isset($title) ? htmlspecialchars($title) : 'Shop Thời Trang'; ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <header>
        <div class="header-content">
            <div class="logo">
                <a href="<?php echo ROOT_URL; ?>">👗 Shop Thời Trang</a>
            </div>
            ...
            <a href="<?php echo ROOT_URL; ?>cart" class="cart-link">
                🛒 Giỏ hàng
                <?php 
